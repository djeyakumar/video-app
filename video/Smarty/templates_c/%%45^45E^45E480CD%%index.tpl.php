...
smarty_core_load_plugins(array('plugins' => array(array('function', 'smarty_fewchars', 'index.tpl', 61, false),array('function', 'dropdown_menu_video_categories', 'index.tpl', 69, false),)), $this); ?>
...
?>
            <div class="item swiper-slide" style="background-image: url(<?php echo @_URL; ?>
/templates/<?php echo $this->_tpl_vars['template_dir']; ?>
/<?php echo $this->_tpl_vars['video_data']['yt_banner']; ?>
)">
                <div class="container">
