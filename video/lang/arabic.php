...
$lang['new_videos'] = 'اضيفت حديثا';
$lang['random_video'] = 'اخترنا لك';
...
$lang['articles_artpostin'] = 'هذه المقالة رفعت في';
$lang['pages'] = 'الصفحات';
$lang['toa'] = 'شروط الاتفاقية'; 
$lang['preroll_ads_timeleft'] = 'هذا الفيديو سيبدأ في خلال';
...
$lang['top_m_videos'] = ' الآكثر مشاهدة';
$lang['top_m_videos_from'] = ' الآكثر مشاهدة من %s';
$lang['genre'] = 'الاقسام';
$lang['members'] = 'الأعضاء';
$lang['mvotd'] = 'ملف اليوم';
$lang['vbwrn'] = 'حلقات تشاهد الآن';
$lang['site_stats'] = 'إحصائيات الموقع';

$lang['recently_added'] = 'حلقات جديد ';
...
$lang['nv_page_title'] = 'جديد المسلسلات من %s';
...
$lang['update_avatar'] = 'تحديث الأفاتار';
$lang['edit_profile'] = 'تحرير الحساب الشخصي';
...
$lang['_in'] = 'in';
$lang['_welcome'] = 'أهلا بكم';
$lang['_new'] = 'جديد';
$lang['_feat'] = 'متميز';
$lang['_duration'] = 'الزمن';
$lang['_like'] = 'اعجبني';
$lang['_likes'] = 'Likes';
$lang['_dislike'] = 'لم يعجبني';
$lang['_dislikes'] = 'Dislikes';
$lang['_share'] = 'مشاركة';
$lang['_embed'] = 'Embed';
$lang['_videourl'] = 'فيديو URL';
$lang['add_to_fav'] = 'إضافة للمفضلة';
$lang['delete_from_fav'] = 'إزالة من المفضلة';
$lang['remove_from_fav'] = 'تمت الإضافة للمفضلة!';
$lang['return_to_ppage'] = 'العودة للصفحة السابقة';
...
$lang['confirm_like'] = ' شكرا ! شاركها مع أصدقائك';
...
$lang['category'] = 'التصنيفات والاقسام';
...
$lang['your_username_or_email'] = 'اسم المستخدم أو الإيميل';
...
$lang['tab_related'] = 'ذو صلة';
$lang['tab_best'] = 'Popular';
$lang['_popular'] = 'Popular';
$lang['bookmark'] = 'إضافة الفيديو للمفضلة';
...
$lang['myfavorites_delete_alert_confirm'] = "أنت على وشك إزالة هذا الفيديو من قائمة المفضلة لديك .انقر إلغاء للتراجع, أو موافق للإزالة";
...
$lang['_social'] = 'روابط التوصل الاجتماعي';
...
$lang['rating_na'] = 'غير مسموح';
$lang['share_msg8'] = 'التضمين غير مُتاح لهذا الملف.';

/*MOBILE MELODY*/
$lang['lmore'] = 'تحميل المزيد';
$lang['lmore_videos'] = 'تحميل المزيد من الفيديوات';
$lang['lmore_comments'] = 'تحميل المزيد من التعليقات';
...
$lang['see_you'] = 'إلى اللقاء';
$lang['browse_art'] = 'استعراض المقالات';
$lang['browse_vid'] = 'استعراض الفيديوات';
$lang['browse_back'] = 'العودة';
$lang['quick_menu'] = 'القائمة السريعة';

$lang['video_not_found'] = 'الفيديو المطلوب غير موجود';
$lang['invalid_csrfguard_token'] = 'Invalid token or session expired, يرجى تحديث الصفحة';

$lang['validate_name'] = 'الرجاء إدخال اسما';
$lang['validate_username'] = 'الرجاء إدخال اسم مستخدم';
$lang['validate_pass'] = 'الرجاء إدخال كلمة مرور';
$lang['validate_email'] = 'الرجاء إدخال بريد الكتروني صالح';
$lang['validate_captcha'] = 'يرجى إدخال رمز صالح';
$lang['validate_agree'] = 'يرجى قبول سياستنا';
...
$lang['validate_video_title'] = 'يرجى إدخال عنون لهذا الفيديو';
...
if (_MOD_SOCIAL)
{
	...
	$lang['status_update'] = 'تحديث الحالة';
	...
	$lang['activity_obj_video'] = 'فيديو';
	$lang['activity_obj_article'] = 'مقالة';
	$lang['activity_obj_comment'] = 'تعليقا';
	$lang['activity_obj_playlist'] = 'a playlist.';
	$lang['activity_obj_status'] = 'حالة';
	
	// Status related
	$lang['user_status_error_empty'] = 'يرجى كتابة شيء ما';
	
	// Notifications related
	$lang['notifications'] = 'الإشعارات';
	$lang['notification_list_empty'] = 'لا يوجد إشعارات';
...
$lang['user_account_banned_label'] = 'محظور'; 
$lang['user_account_banned'] = 'محظور';
$lang['user_account_add_ban'] = 'حظر حساب';
$lang['user_account_remove_ban'] = 'إزالة حساب';
$lang['registration_closed'] = 'التسجيل مغلق';
...
$lang['article_no_articles'] = 'عذرا لايوجد مقالات هنا';
...
$lang['swfupload_file'] = 'ملف';
$lang['swfupload_status_uploaded'] = 'تم الرفع';
$lang['swfupload_status_queued'] = 'Queued';
$lang['swfupload_status_pending'] = 'Continue with the rest of the form.';
$lang['swfupload_status_uploading'] = 'قيد الرفع...';
$lang['swfupload_status_error'] = 'خطأ';
$lang['swfupload_btn_select'] = 'اختيار'; 
$lang['swfupload_btn_cancel'] = 'إلغاء';
...
$lang['memberlist_msg3'] = 'لا يوجد مستخدمين';
...
$lang['switch_to_mobile_ui'] = 'الانتقال لوضع الهاتف المحمول'; // anchor text
$lang['switch_to_desktop_ui'] = 'الانتقال لوضع اجهزة الكمبيوتر PC'; // anchor text

$lang['page_number'] = 'صفحة %s';
$lang['preroll_ads_skip_msg'] = 'يمكن الانتقال للفيديو خلال';
$lang['preroll_ads_skip'] = 'تجاوز';
$lang['follow_suggested'] = 'Suggested Profiles';
$lang['hide'] = 'إخفاء';
$lang['close'] = 'إغلاق';
$lang['_pending'] = 'معلق';
$lang['pending_approval'] = 'معلق بانتظار الموافقة';

$lang['_grid'] = 'شبكة'; // Method of viewing listings
$lang['_list'] = 'قائمة'; // Method of viewing listings
$lang['_watched'] = 'تمت مشاهدته'; // Video status
$lang['watch_later'] = 'شاهد لاحقا'; 
...
$lang['video_ordering'] = 'ترتيب الفيديوات';
$lang['most_popular'] = 'الأكثر شعبية';

$lang['_manual'] = 'Manual'; // As in: "Select manually"; not "manual" as an "instructions manual". 

$lang['sort_added_new'] = 'تاريخ الإضافة من الأحدث للأقدم';
$lang['sort_added_old'] = 'تاريخ الإضافة من الأقدم للأحدث';
$lang['sort_published_new'] = 'تاريخ النشر من الأحدث للأقدم';
$lang['sort_published_old'] = 'تاريخ النشر من الأقدم للأحدث';

$lang['submit_cancel'] = 'إلغاء';
$lang['submit_delete'] = 'حذف';

$lang['playlist_next_video'] = 'الفيديو التالي';
$lang['playlist_prev_video'] = 'الفيديو السابق';
...
$lang['i_agree_with'] = 'موافق';
$lang['terms_of_agreement'] = 'شروط الاتفاقية';
...
$lang['show_menu'] = 'إظهار القائمة';
$lang['sort_by'] = 'Sort by'; // E.g. "Sort by" Date Added 
$lang['new_playlist'] = 'New playlist'; 
$lang['_about'] = 'حول'; // Short from "About me". Meaning: Learn more
$lang['_you'] = 'أنت'; 
$lang['this_is_you'] = 'هذا هو حسابك الشخصي';
$lang['share_on_social'] = 'نشر على وسائط التواصل الاجتماعي';
$lang['share_via_email'] = 'أرسل لصديق عير الايميل';
...
$lang['channel_cover_save_error'] = 'حصل خطأ اثناء الحفظ';
...
$lang['subscriber'] = 'مشترك'; // as in "Your subscriber"
$lang['subscribers'] = 'مشتركون';
$lang['subscription'] = 'الاشتراك';
$lang['subscriptions'] = 'الاشتراكات';
$lang['subscribe_to'] = 'اشترك بـ';
$lang['subscribed_to'] = 'مشترك بـ';
$lang['channel'] = 'قناة';
$lang['channels'] = 'قنوات';
$lang['my_channel'] = 'قناتي';
$lang['verified'] = 'Verified';
$lang['featured'] = ' مـميـز ';
$lang['verified_channel'] = 'Verified Channel';
$lang['featured_channel'] = 'قناة مميزة';
$lang['suggested_channels'] = 'قنوات مقترحة';
$lang['delete_video_confirmation'] = 'هل انت متأكد من أنك تريد حذف هذا الفيديو؟';
$lang['access_denied'] = 'You do not have permission to access this page.';
$lang['edit_video'] = 'تحرير فيديو';
$lang['save_changes'] = 'حفظ التغييرات';
$lang['replace_video'] = 'استبدال فيديو';
$lang['replace_file'] = 'استبدال ملف';
$lang['delete_this_video'] = 'حذف هذا الفيديو';
$lang['video_pending_approval'] = 'هذا الفيديو ينتظر الموافقة';
...
// @since 2.7
$lang['click_to_watch'] = 'انقر هنا للمشاهدة';
$lang['_watch'] = 'مشاهدة';
$lang['from_playlist'] = 'This video is part of the "%s" playlist.';
$lang['_advertisment'] = 'الإعلان';
$lang['logging_in'] = 'يتم تسجيل الدخول...';
$lang['_published'] = 'منشور';
