				...
				{foreach from=$categories_data key=k item=category_data}
					...
					<li>
						...
						<a href="{$category_data.url}">
							<span class="pm-video-thumb pm-thumb-288 pm-thumb">
								<div class="pm-thumb-fix pm-thumb-288"><span class="pm-thumb-fix-clip"><img src="{$category_data.image_url}" alt="{$category_data.attr_alt}" width="288"><span class="vertical-align"></span></span></div>
							</span>
