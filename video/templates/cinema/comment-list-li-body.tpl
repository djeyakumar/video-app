<span class="pm-comment-avatar">
	{if $comment_data.user_id == 0}
		<span class="pm-img-avatar"><img src="{$comment_data.avatar_url}" height="40" width="40" alt="" class="img-circle"></span>
	{else}
		<span class="pm-img-avatar"><a href="{$comment_data.user_profile_href}"><img src="{$comment_data.avatar_url}" height="40" width="40" alt="" class="img-circle"></a></span>
	{/if}
</span>
