            ...
            {foreach from=$submitted_video_list key=k item=video_data}
              <li>
                <div class="pm-li-video{if $video_data.pending_approval} pending{/if}">
                    ...
                    <a href="{$video_data.video_href}" class="pm-thumb-fix pm-thumb-288"><span class="pm-thumb-fix-clip"><img src="{$video_data.thumb_img_url}" alt="{$video_data.video_title}" width="288"><span class="vertical-align"></span></span></a>
                    {if $video_data.pending_approval}<div class="pending-approval">{$lang.pending_approval}</div>{/if}
                    </span>
                    
                    <h3 class="alpha60"><a href="{$video_data.video_href}" class="pm-title-link" title="{$video_data.video_title}">{$video_data.video_title}</a></h3>
