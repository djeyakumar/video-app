...
<div id="wrapper">
    ...
    {if $logged_in == '1'}
			...
			{else}
				<div class="pm-playlist-edit">
					<div class="pm-pl-header row-fluid">
						...
						<div class="pm-pl-header-content span10">
      ...
      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Share on FaceBook"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/facebook-round.png" alt=""></a>
                    <a href="https://twitter.com/home?status=Watching%20{$share_link_urlencoded}%20on%20{$share_title_urlencoded}" onclick="javascript:window.open(this.href,
      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" title="Share on Twitter"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/twitter-round.png"  alt=""></a>
      ...
      src="{$smarty.const._URL}/templates/{$template_dir}/img/gplus-round.png" alt=""></a>
                    ...
                    <div class="input-prepend"><span class="add-on">URL</span><input name="share_video_link" id="share_video_link" type="text" value="{$share_link}" class="span11" onClick="SelectAll('share_video_link');"></div>
                    </div>
                </div>
