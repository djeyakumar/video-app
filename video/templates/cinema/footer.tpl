...
$("#jump-comments").click(function() {
   scrollToAnchor('view-comments');
});
...
$(document).ready(function() {
	$("#pm-ul-tabr-videos").carouFredSel({
		items				: 7,
		circular			: true,
		direction			: "left",
		infinite			: true,
		responsive			: true,
		prev	: {	
			button	: "#pm-slide-tabr-prev",
			key		: "left"
		},
		next	: { 
			button	: "#pm-slide-tabr-next",
			key		: "right"
		},
	scroll		: {
		fx				: "slide",
...
$(document).ready(function() {
	$("#pm-ul-tabp-videos").carouFredSel({
		items				: 7,
		circular			: true,
		direction			: "left",
		infinite			: true,
		responsive			: true,
		prev	: {	
			button	: "#pm-slide-tabp-prev",
			key		: "left"
		},
		next	: { 
			button	: "#pm-slide-tabp-next",
			key		: "right"
		},
	scroll		: {
		fx				: "slide",
